...
<script src="LIB/jquery.lightbox.js"></script>
<script>
  // Initiate Lightbox
  $(function() {
    $('.gallery a').lightbox(); 
...
<div class="header_right">
	<div class="cssmenu">
		<ul>
			...
			<li><a href="prepost.php"><span>About</span></a></li>
			<li><a href="staff.php"><span>Staff</span></a></li>
			<li class="active" class="has-sub"><a href="service.php"><span>Services</span></a></li>
...
<div class="main">
	<div class="ser-main">
		...
		<div class="ser-grid-list img_style">
			<div class="gallery">
				<a href="IMG/ser_pic1.jpg"><img src="IMG/ser_pic1.jpg" title="image-name"></a>
			</div>
		...
		<div class="ser-grid-list img_style">
			<div class="gallery">
				<a href="IMG/ser_pic2.jpg"><img src="IMG/ser_pic2.jpg" title="image-name"></a>
			</div>
		...
		<div class="ser-grid-list img_style">
			<div class="gallery">
				<a href="IMG/ser_pic3.jpg"><img src="IMG/ser_pic3.jpg" title="image-name"></a>
			</div>
				<h5>pellentesque at ultrices</h5>
		...
		<div class="ser-grid-list img_style">
			<div class="gallery">
				<a href="IMG/ser_pic4.jpg"><img src="IMG/ser_pic4.jpg" title="image-name"></a>
			</div>
			<h5> Nunc easi diam risus</h5>
			<p class="para">Qsi turpis, pellentesque at ultrices in, dapibus in magna. Nunc easi diam risus, placerat ut scelerisque etplacet scelerisque ,Nunc easi diam risus, placerat ut scelerisque et, </p>
			<div class="button1">
